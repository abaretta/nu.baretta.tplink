...
class Plug extends Device {
  ...
  constructor(options) {
    ...
    Object.defineProperty(this, _child, {
      writable: true,
      value: void 0
    });
    Object.defineProperty(this, _childId, {
      writable: true,
      value: void 0
    });
  ...
  get children() {
    return _classPrivateFieldLooseBase(this, _children)[_children];
  }
  /**
   * @private
   */
  ...
  set children(children) {
    if (Array.isArray(children)) {
      _classPrivateFieldLooseBase(this, _children)[_children] = new Map(children.map(child => {
        // eslint-disable-next-line no-param-reassign
        child.id = this.normalizeChildId(child.id);
        return [child.id, child];
      }));
    } else if (children instanceof Map) {
      _classPrivateFieldLooseBase(this, _children)[_children] = children;
    }

    if (_classPrivateFieldLooseBase(this, _childId)[_childId] && _classPrivateFieldLooseBase(this, _children)[_children]) {
      this.childId = _classPrivateFieldLooseBase(this, _childId)[_childId]; // this.#child = this.#children.get(this.normalizeChildId(this.#childId));
    }
  }
  /**
   * Returns childId.
  ...
  get childId() {
    return _classPrivateFieldLooseBase(this, _childId)[_childId];
  }
  /**
   * @private
   */
  ...
  set childId(childId) {
    _classPrivateFieldLooseBase(this, _childId)[_childId] = this.normalizeChildId(childId);

    if (_classPrivateFieldLooseBase(this, _childId)[_childId] && _classPrivateFieldLooseBase(this, _children)[_children]) {
      _classPrivateFieldLooseBase(this, _child)[_child] = _classPrivateFieldLooseBase(this, _children)[_children].get(_classPrivateFieldLooseBase(this, _childId)[_childId]);
    }

    if (_classPrivateFieldLooseBase(this, _childId)[_childId] && _classPrivateFieldLooseBase(this, _child)[_child] == null) {
  ...
  get alias() {
    if (this.childId) {
      return _classPrivateFieldLooseBase(this, _child)[_child].alias;
    }
  ...
  set alias(alias) {
    if (this.childId) {
      _classPrivateFieldLooseBase(this, _child)[_child].alias = alias;
    }
  ...
  get relayState() {
    if (this.childId) {
      return _classPrivateFieldLooseBase(this, _child)[_child].state === 1;
    }
  ...
  set relayState(relayState) {
    if (this.childId) {
      _classPrivateFieldLooseBase(this, _child)[_child].state = relayState ? 1 : 0;
      return;
    }
  ...
  async blink(times = 5, rate = 1000, sendOptions) {
    ...
    for (let i = 0; i < times * 2; i += 1) {
      ...
      lastBlink = Date.now(); // eslint-disable-next-line no-await-in-loop
...
var _children = _classPrivateFieldLooseKey("children");

var _child = _classPrivateFieldLooseKey("child");

var _childId = _classPrivateFieldLooseKey("childId");
